  ...
  (syntax-rules (opt cat key rec and values)
    ...
    ((%alet (var) ((n v) ***) () bd ***)
     ((letrec ((var (lambda (n ***) bd ***)))
        var) v ***)
     (with ((var (gensym)))
       (labels ((var (n ***) bd ***)) (declare (line 39)) (var v ***))))
    ...
    ((%alet "rec" (p ***) (nv ***) ((n v t) ***) () (bn ***) bd ***)
     ((let ((n '<undefined>) ***)(declare (line 191))
	(let ((t v) ***)(declare (line 192))
	  (set! n t) ***
	  (mu n ***)))
      (lambda (t ***) (declare (line 195))(%alet (p ***) (nv ***) (bn ***) bd ***))))
...
(define-syntax lambda*
  (syntax-rules ()
    ...
    ((lambda* "star" (t ***) (n ***) () bd ***)
     (lambda (t ***)
       (declare (line 532))
       ;mbe (let* ((n t) ***) (declare (line 533)) bd ***)
