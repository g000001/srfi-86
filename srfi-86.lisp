...
(define-syntax mu
  (syntax-rules ()
    ((mu argument ***)
     (with ((f (gensym)))
       (lambda (f) (multiple-value-call f argument ***))))))

(define-syntax nu
  (syntax-rules ()
    ((nu argument ***)
     (with ((f (gensym)))
       (lambda (f) (multiple-value-call apply f argument ***))))))
...
(define-syntax %alet
  (syntax-rules (opt cat key rec and values)
    ...
    ((%alet "dot" (p ***) (nv ***) (t ***) (() c) (bn ***) bd ***)
     (funcall c (lambda (t ***) (%alet (p ***) (nv ***) (bn ***) bd ***))))
    ((%alet "dot" (p ***) (nv ***) (t ***) (() c ***) (bn ***) bd ***)
     ((lambda (t ***) (%alet (p ***) (nv ***) (bn ***) bd ***)) c ***))
    ((%alet "dot" (p ***) (nv ***) (t ***) (b c) (bn ***) bd ***)
     (with ((tn (gensym)))
       (funcall c (lambda (t *** &rest tn)
                    (%alet (p ***) (nv *** (b tn)) (bn ***) bd ***)))))
    ((%alet "dot" (p ***) (nv ***) (t ***) (b c ***) (bn ***) bd ***)
     (with ((tn (gensym)))
       ((lambda (t *** &rest tn)
    ...
    ((%alet "not" (p ***) (nv ***) (t ***) (z) (bn ***) bd ***)
     (funcall z (lambda (t ***) (%alet (p ***) (nv ***) (bn ***) bd ***))))
    ((%alet (p ***) (nv ***) ((a) bn ***) bd ***)
...
(define-syntax alet*
  (syntax-rules (opt cat key rec and values)
    ...
    ((alet* ((a . b) bn ***) bd ***)
     (%alet* () () ((a . b) bn ***) bd ***))
    ((alet* (a b bn ***) bd ***)
     (funcallb b (lambda a (alet* (bn ***) bd ***))))
    ((alet* var (bn ***) bd ***)
     (%alet* (var) () (bn ***) bd ***))))
...
(define-syntax %alet*
  (syntax-rules (opt cat key rec and values)
    ...
    ((%alet* (p ***) (n ***) (a b bn ***) bd ***)
     (funcallb b (lambda a (%alet* (p ***) (n *** a) (bn ***) bd ***))))))
